...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver {
  ...
  Widget _buildPetList() {
    return Obx(() {
      ...
      final petListToDisplay = _controller.petList.length > 2
          ? _controller.petList
              .sublist(_controller.petList.length - 2) // เลือก 2 รายการสุดท้าย
          : _controller.petList;
  ...
  Widget _buildPetButton(PetModel pet) {
    return GestureDetector(
      ...
      child: Container(
        //--------------> ขนาด วงกลม pet profile ก่อน ปุ่ม add
        margin: const EdgeInsets.only(right: 20),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: HeaderButton(
                          ...
                          backgroundColor:
                              const Color(0xFF93B4FB), // พื้นหลังเป็นสี #93B4FB
      ...
      child: Container(
        ...
        child: Center(
          child: SvgPicture.asset(
            ...
            height: 16,
            colorFilter:
                ColorFilter.mode(iconColor, BlendMode.srcIn), // เปลี่ยนสีไอคอน
          ),
        ),
      ),
    );
